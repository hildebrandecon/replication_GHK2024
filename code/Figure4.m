...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_a', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4a done')

%% Figure 4b: nominal rate, annualized ------------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_b', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4b done')

%% Figure 4c: savers' goods consumption -----------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_c', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4c done')

%% Figure 4d: core inflation, annualized ----------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_d', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4d done')

%% Figure 4e: employment --------------------------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_e', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4e done')

%% Figure 4f: inequality --------------------------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_f', '.pdf'], '-dpdf', '-r0', '-fillpage')
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_g', '.pdf'], '-dpdf', '-r0', '-fillpage')

disp('Figure 4g done')

%% Figure 4h: exports to GDP ----------------------------------------------
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_h', '.pdf'], '-dpdf', '-r0', '-fillpage')
...
% save figure
orient landscape
print(fig, [Opt.respath, '/figures/', 'Figure4_i', '.pdf'], '-dpdf', '-r0', '-fillpage')
