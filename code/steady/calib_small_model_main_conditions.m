function F = calib_small_model_main_conditions(x, param)
...
ptau_w = param.ptau_w;
baseline_pchi = param.baseline_pchi;
baseline_xi_E = param.baseline_xi_E;
...
% targets
F(count) = (pchi) - (baseline_pchi); count = count + 1;
F(count) = (xi_E) - (baseline_xi_E); count = count + 1;
